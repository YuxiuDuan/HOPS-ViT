...
from .quantizer import UniformQuantizer, LogSqrt2Quantizer, UniformQuantizer_Attn, Log2Quantizer
...
class QuantMatMul(nn.Module):
    ...
    def __init__(self,
        ...
        if 'log_quant' in input_quant_params_matmul:
            ...
            # self.quantizer_A = UniformQuantizer_Attn(**input_quant_params_matmul)
        else:
            self.quantizer_A = UniformQuantizer(**input_quant_params_matmul)
        # self.quantizer_A = UniformQuantizer(**input_quant_params_matmul)
